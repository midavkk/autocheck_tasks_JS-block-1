...
// общими будут числа 3 и 5, т.к.они присутствуют в обоих исходных
// массивах.А числа 0, 1 и 8 присутствуют только в одном из массивов.
// Напиши функцию getCommonElements(array1, array2) которая
// получает два массива произвольной длины в параметры array1 и array2,
...
function getCommonElements(array1, array2) {
  ...
  for (const index1 of array1) {
    if (array2.includes(index1)) {
      resultArray.push(index1);
    }
  }
  return resultArray;
...
// 1. перебираем массив 1
// 2. инклудом ищем наличие элементов массива 1 в массиве 2
// 3. при совпадении - пушим в новый массив
// const array1 = [1, 2, 3];
// const array2 = [2, 4];
// let resultArray = [];
// for (const index1 of array1) {
